...
values_tps = array_tps[0].split(' ') #defining values as individual components in the array split by blank space this takes the 0th one
print(values_tps)    
...
values_csv = array_csv[0].split(',') #defining values as individual components in the array split by blank space this takes the 0th one
print(values_csv)    
