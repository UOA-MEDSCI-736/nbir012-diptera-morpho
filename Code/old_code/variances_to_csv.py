...
path = "../Data/relative_warps_data_arrange.csv"
...
with open('../Data/relative_warps.csv','r') as file: #define file and open required tps file #I need to make this relative
    for line in file: #create loop using each line (string) within the file
        ...
        data2.append(b)#this is appending all the data in b into tps_array
